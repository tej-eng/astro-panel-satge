      ...
      {cards.map((card, index) => (
        ...
        >
          ...
          <div className="text-base text-gray-800 leading-relaxed mb-4 min-h-35">
            ...
            <p>3. Always accept all calls and chats when you are online.</p>
            <p>
            ...
            <p>5. Be respectful and polite to the customer in every manner.</p>
            <p>
            ...
            <p>२. आपको हर दिन न्यूनतम ४ घंटे के लिए उपलब्ध होना चाहिए।</p>
            <p>
            ...
            <p>५. हर तरह से ग्राहक के प्रति सम्मानजनक और विनम्र रहें।</p>
            <p>
